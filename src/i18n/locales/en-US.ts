export default {
  ...
  errorCodes: {
    ...
    CANNOT_LINK_SELF: 'Cannot link a note to itself',
    PROFILE_NOT_FOUND: 'Profile not found: {0}',
    NO_VALID_SQL_STATEMENTS: 'No valid INSERT statements found in SQL file',
    SQL_EXEC_FAILED: 'Failed to execute SQL: {0}',
    PASSWORD_HASH_FAILED: 'Password hashing failed: {0}',
    PASSWORD_HASH_INVALID: 'Invalid password hash format: {0}',
    // Server backend errors
    SERVER_FEATURE_NOT_SUPPORTED: 'This feature is not available when using a server backend',
    SERVER_AUTH_FAILED: 'Server authentication failed, please check your credentials',
    SERVER_FORBIDDEN: 'Access denied by server',
    SERVER_NOT_FOUND: 'Resource not found on server',
    SERVER_RATE_LIMITED: 'Too many requests, please try again later',
    SERVER_ERROR: 'Server error: {0}',
    SERVER_UNEXPECTED: 'Unexpected server response: {0}',
    SERVER_CONNECTION_FAILED: 'Cannot connect to server: {0}',
    SERVER_CONFIG_MISSING: 'Server configuration is missing',
    SERVER_TIMEOUT: 'Server request timed out',
    SERVER_REQUEST_FAILED: 'Server request failed: {0}',
    SERVER_PARSE_ERROR: 'Failed to parse server response: {0}',
    SERVER_VALIDATION_ERROR: 'Server validation error',
    NOT_SERVER_BACKEND: 'Current profile is not a server backend',
  },
  ...
  settings: {
    ...
    cloudBackupEnabled: 'Enable cloud backup',
    cloudBackupProvider: 'Storage Provider',
    cloudBackupEndpoint: 'Endpoint',
    ...
    cloudBackupPrefix: 'Path Prefix',
    cloudBackupUsername: 'Username',
    cloudBackupPassword: 'Password',
    cloudBackupRetention: 'Cloud retention count',
    ...
    cloudBackupNow: 'Backup to Cloud',
    cloudBackupSuccess: 'Cloud backup success: {name}',
    cloudBackupFailed: 'Cloud backup failed',
    cloudBackupUploadFailed: 'Upload to cloud failed',
    cloudBackupLastBackup: 'Last cloud backup',
    cloudBackupProviderS3: 'AWS S3',
    cloudBackupProviderOss: 'Alibaba Cloud OSS',
    cloudBackupProviderCos: 'Tencent Cloud COS',
    cloudBackupProviderMinio: 'MinIO',
    cloudBackupProviderWebdav: 'WebDAV',
    cloudBackupConfigSaved: 'Cloud backup config saved',
    cloudBackupConfigSaveFailed: 'Failed to save cloud backup config',
    cloudBackupDownloadSuccess: 'Downloaded: {name}',
    cloudBackupDownloadFailed: 'Download failed',
    cloudBackupListTitle: 'Cloud Backups',
    cloudBackupEmpty: 'No cloud backups',
    ...
    mcpToolSearchTodos: 'Search Todos',
    mcpToolGetTodo: 'Get Todo',
    mcpToolCreateTodo: 'Create Todo',
    mcpToolUpdateTodo: 'Update Todo',
    mcpToolCompleteTodo: 'Toggle Completion',
    mcpToolDeleteTodo: 'Delete Todo',
    mcpToolListTodoLists: 'List Todo Lists',
    mcpToolCreateTodoList: 'Create Todo List',
    mcpToolTodoStats: 'Todo Statistics',
    // System Maintenance
  ...
  todo: {
    title: 'Todo',
    add: 'New Todo',
    addPlaceholder: 'Enter a todo title...',
    edit: 'Edit Todo',
    delete: 'Delete Todo',
    deleteConfirm: 'Delete this todo?',
    empty: 'No todos',
    emptyCompleted: 'No completed todos',
    titleRequired: 'Todo title cannot be empty',
    completed: 'Completed',
    dueDate: 'Due date',
    ...
    deleteListConfirm: 'Delete this list? Todos in it will not be deleted.',
    unassigned: 'Unassigned',
    restore: 'Restore',
    permanentDelete: 'Delete Permanently',
    emptyTrash: 'Empty Trash',
    emptyTrashConfirm: 'Empty the trash? This action cannot be undone.',
    ...
    recurrenceInterval: 'Every N periods',
    recurrenceEndDate: 'Repeat until',
    subtask: 'Subtask',
    addSubtask: 'Add subtask',
    subtaskCount: '{count} subtasks',
    relatedNote: 'Linked Note',
    noRelatedNote: 'None',
    tags: 'Tags',
    batchMode: 'Batch',
    selectAll: 'Select All',
    selectedCount: '{count} selected',
    batchComplete: 'Mark Done',
    batchDelete: 'Delete',
    batchMove: 'Move to List',
    ...
    pomodoroPause: 'Pause',
    pomodoroReset: 'Reset',
    pomodoroDone: 'Focus session finished, take a break',
    noSelection: 'Select a todo on the left to see its details',
  },
  ...
  setup: {
    ...
    dbType: {
      ...
      enoteServer: 'ENote Server',
      enoteServerDesc: 'Connect to a remote ENote-compatible API server',
    },
    ...
    serverUrlPlaceholder: 'e.g. https://notes.example.com',
    serverAuthMethod: 'Authentication',
    serverAuthNone: 'None',
    serverAuthBearer: 'Bearer Token',
    serverAuthBasic: 'Basic (Username/Password)',
    serverAuthJwt: 'JWT (Auto-refresh)',
    serverAuthCustomHeader: 'Custom Header',
    serverAuthOAuth2: 'OAuth 2.0',
    serverToken: 'Token',
    serverTokenPlaceholder: 'Enter Bearer Token or API Key',
    serverRefreshUrl: 'Token Refresh URL',
    serverRefreshUrlPlaceholder: 'e.g. /auth/refresh',
    serverHeaderName: 'Header Name',
    serverHeaderNamePlaceholder: 'e.g. X-API-Key',
    serverHeaderValue: 'Header Value',
    serverOAuthTokenUrl: 'Token URL',
    serverOAuthClientId: 'Client ID',
    serverOAuthClientSecret: 'Client Secret',
    serverOAuthScopes: 'Scopes',
    serverEncryptionNote: 'Content encryption is handled by the server',
    serverTimeout: 'Request Timeout (seconds)',
    // Actions
  ...
  sync: {
    ...
    syncCompleteWithFailures: 'Sync completed: {success} succeeded, {failed} failed',
    syncCompleteSuccess: 'Sync completed: {count} records',
    deleteSuccess: 'Deleted successfully',
    clearAllSuccess: 'All sync records cleared',
    exportSuccess: 'Export successful',
    settingsCount: '{count} settings',
    sourceNoteNotFound: 'Source note not found',
    progressClearTarget: 'Clear target data',
  ...
  log: {
    ...
    dbLogs: 'Activity Logs',
    fileLogs: 'System Logs',
    ...
    clearAll: 'Clear All',
    cleanupOld: 'Clean up older than 30 days',
    clearedCount: 'Cleaned up {count} records',
    noFiles: 'No log files found',
    searchInFile: 'Search in file...',
    selectFileHint: 'Select a log file from the left to view',
    fileDeleted: 'Log file deleted',
    cleanupOldFiles: 'Clean up files older than 30 days',
    refresh: 'Refresh',
    openLogManager: 'Open Log Manager',
    fileLogEnabled: 'Enable file logging',
    fileLogLevel: 'File log level',
    fileRetentionDays: 'File retention days',
    dbLogEnabled: 'Enable activity logging',
    dbRetentionDays: 'Activity log retention days',
