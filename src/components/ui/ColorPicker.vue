<template>
  <div class="relative inline-block" ref="pickerRef">
    ...
    <Transition name="picker">
      <div
        v-if="visible"
        class="absolute top-full left-0 mt-1 p-3 bg-white rounded-lg shadow-lg border border-gray-200 z-50"
      >
        <div class="grid grid-cols-5 gap-1 mb-2">
          <button
            ...
            :class="{ 'ring-2 ring-green-500 ring-offset-1': modelValue === color }"
          ></button>
        </div>
        <div class="flex items-center gap-2 pt-2 border-t border-gray-200">
          ...
          <input
            ...
            class="flex-1 h-8 px-2 text-sm border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500"
            placeholder="#000000"
          />
        </div>
      </div>
